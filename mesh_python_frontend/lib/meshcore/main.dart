...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<ChatMessage> messages = [
    ChatMessage(text: "Hii", outgoing: false, senderName: "the woofer"),
    ChatMessage(text: "Hewwo :3", outgoing: true),
    ChatMessage(text: "woof woof!", outgoing: false, senderName: "the woofer"),
    ChatMessage(text: "waf!", outgoing: true),
    ChatMessage(text: "bark!", outgoing: false, senderName: "the woofer"),
    ...
    ChatMessage(text: "bark!", outgoing: false, senderName: "the woofer"),
    ChatMessage(text: "awoo!", outgoing: true),
    ChatMessage(text: "woof woof!", outgoing: false, senderName: "the barker"),
    ChatMessage(text: "waf!", outgoing: true),
    ChatMessage(text: "bark!", outgoing: false, senderName: "the barker"),
    ChatMessage(text: "awoo!", outgoing: true),
    ChatMessage(text: "woof woof!", outgoing: false, senderName: "the barker"),
    ChatMessage(text: "waf!", outgoing: true),
    ChatMessage(text: "bark!", outgoing: false, senderName: "the barker"),
